...
public class MainJDC extends ApplicationAdapter {
	private int idCliente;
	private String ipIngresado;
	//TEXTURAS
	...
	Cliente unico;
	/*CONSTRUCTOR*/
	public MainJDC(String ipIngresado,int numJugadores){
		this.ipIngresado=ipIngresado;
		this.numJugadores=numJugadores;
		System.out.println("IPSERVIDOR QUE LLEGA A MAIN  "+ipIngresado);
		System.out.println("IPSERVIDOR QUE LLEGA A MAIN  "+ipIngresado);
	}
	@Override
	public void create () {
		...
		//instanciado de cliente
		unico=new Cliente(1,getIpIngresado(),getNumJugadores());
	}
	...
	public void inicializaJugadorMostroCliente(){
		...
		if(numReset==0){
			...
			player=new Jugador(0,0,tablero,menu);
			//PARA INSTANCIAR TABLERO
			escenario=new Tablero(tablero,batch,player);
			//INSTANCIA MOSTROS
			for(int i=0;i<numCpus ;i++)
			{
				cpus[i]=new mostro(8*espacioX,5*espacioY,tablero);
			}
		...
		//CUANDO LO RESETEA
			...
			for(int i=0;i<numCpus ;i++)
			{
				cpus[i].setX(8*espacioX);cpus[i].setY(5*espacioY);
			}
		}
...
///////////PANTALLAS DE DIBUJO DEL JUEGO////////////////////////////////////////////////////////////////////
	...
	public String getIpIngresado() {
		return ipIngresado;
	}

	public void setIpIngresado(String ipIngresado) {
		this.ipIngresado = ipIngresado;
	}
